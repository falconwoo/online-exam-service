...
public class JerseyConfig extends ResourceConfig {
    private static final String[] MODULE_PACKAGES = new String[]{
        "com.thoughtworks.online_exam.product.endpoint",
        "com.thoughtworks.online_exam.auth.endpoint"
    };

    public JerseyConfig() {
        // common packages
        this.packages(
            "com.thoughtworks.online_exam.common.exception.handler"
        );
    ...
    protected void initSwaggerBeanConfig() {
        ...
        beanConfig.setBasePath("/online_exam/rest");
